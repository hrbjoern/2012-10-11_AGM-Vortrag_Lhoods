...
\beq
\mathcal{CL} = \prod_i \L_i
\eeq

 ~ 

Include uncertainty of \jbar for each data set:
...
Hence, the full combined likelihood is a function of:
\bit
  ...
  \item and, of course, the experimental results (\non, \noff)
\eit 

 ~ 

Next step: Calculate the combined profile likelihood $\mathcal{PL}$,
as a function of fixed $\sigmav_f$, for each given DM mass \ra maximize over the $\jbar$'s:
