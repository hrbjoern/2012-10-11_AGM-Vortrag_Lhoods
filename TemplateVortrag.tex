...
\title[DM \& HESS]{Dark matter searches with H.E.S.S.}
\author[B. Opitz, Univ. Hamburg: ]{Bj\"{o}rn
  Opitz\footnote{bjoern.opitz@desy.de}, Universit\"at Hamburg}
%on behalf of the H.E.S.S. collaboration}
\institute[Univ. Hamburg]{}
%{\normalsize{on behalf of the H.E.S.S. collaboration}}
%{\normalsize{Universit\"at Hamburg, Institut
%    f\"ur Experimentalphysik}}  

\begin{document}
\date{ %\today
%  \small{
    Dark Matter at Leicester --- January 18, 2010 (!)
%} \\  \vspace{3mm} October 8, 2009
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Numerische Integration für Anfänger}
...
%  \item \emph{Über die upper limits müssen wir nochmal reden ...}
\eit
\end{block}
